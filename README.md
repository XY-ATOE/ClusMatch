...
CUDA_VISIBLE_DEVICES=2 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar10_40_0.yaml
CUDA_VISIBLE_DEVICES=2 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar10_60_0.yaml
CUDA_VISIBLE_DEVICES=3 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar10_600_0.yaml
CUDA_VISIBLE_DEVICES=0 python train.py --c config/classic_cv/freematch/freematch_cifar100_400_0.yaml
CUDA_VISIBLE_DEVICES=0 python train.py --c config/classic_cv/freematch_neg/freematchneg_imagenetdogs_1950_0.yaml
CUDA_VISIBLE_DEVICES=3 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar100_400_0.yaml


CUDA_VISIBLE_DEVICES=1 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar100_6000_0_propos.yaml
CUDA_VISIBLE_DEVICES=0 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar10_600_0_propos.yaml

CUDA_VISIBLE_DEVICES=1 python train.py --c config/classic_cv/freematch_neg/freematchneg_imagenetdogs_1950_0_propos.yaml

CUDA_VISIBLE_DEVICES=0 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar100_600_0.yaml
CUDA_VISIBLE_DEVICES=1 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar100_600_0.yaml
CUDA_VISIBLE_DEVICES=2 python train.py --c config/classic_cv/freematch_neg/freematchneg_cifar10_600_0.yaml

CUDA_VISIBLE_DEVICES=3 python train.py --c config/classic_cv/freematch_neg/freematchneg_tinyimagenet_10000_0_propos.yaml
```
